...
import com.bajookie.lost_geodes.entity.custom.MoltenChamberShotProjectile;
...
public class MoltenChamber extends Item implements IArtifact, IStackPredicate, IHasCooldown, IRaidReward {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        // tooltip.add(TextUtil.translatable("tooltip.lost_geodes.molten_chamber.effect.info1", new TextArgs().putF("damage_min", this.SHOT_DAMAGE.get(stack)).putF("damage_max", SHOT_AMP.max * this.SHOT_DAMAGE.get(stack))));
